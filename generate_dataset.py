...
def parse():
    ...
    parser.add_argument('--out_img_size', help='Path for the generated images', default=128)
...
def main(args):
    ...
    for k in range(int(args.dataset_size)):
        rotation_angle = np.random.randint(low=0,high=359) # Generate an angle at random
